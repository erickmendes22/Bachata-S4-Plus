...
diag=r'''    const auto& src_info = src_image.info;
    ...
    if (p20_emit) {
        ...
        LOG_WARNING(Render_Vulkan,
          ...
          vk::to_string(info.pixel_format),static_cast<bool>(src_info.props.is_depth),static_cast<bool>(info.props.is_depth),
          static_cast<bool>(src_info.props.has_stencil),static_cast<bool>(info.props.has_stencil),
